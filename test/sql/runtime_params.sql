...
-- this cluster's postgresql.conf currently sets, while boot_val is the
-- compiled-in default and stays fixed regardless of that override.
...
ALTER SYSTEM SET svs.max_residency_memory = 0;
ALTER SYSTEM SET svs.default_residency_memory = 0;
ALTER SYSTEM SET svs.max_search_work_mem = 0;
